...
import Evolua.application.entities.dto.usuario.AlterarObjetivoRequest;
...
public class UsuarioController {
    ...
    public ResponseEntity<Void> alterarObjetivo(@Positive @PathVariable Long id, @RequestBody AlterarObjetivoRequest request){
        usuarioService.alterarObjetivo(id, request.objetivo());
